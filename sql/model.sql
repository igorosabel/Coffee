CREATE TABLE `person` (
  ...
  `num_special` int(11) NOT NULL COMMENT 'Número de viernes que ha bajado',
  `num_special_pay` int(11) NOT NULL COMMENT 'Número de viernes que ha pagado',
...
CREATE TABLE `coffee` (
  ...
  `id_person` int(11) NOT NULL COMMENT 'Id de la persona que ha pagado',
